...
function init() {
    ...
    var polyline = L.polyline([[57, -19], [60, -12]], {
                    color: '#33EE33',
                    opacity: 1,
                    weight: 5,
                    clickable: true
    ...
    var decorator = L.polylineDecorator(polyline, {
        patterns: [
            ...
            {offset: '50%',  symbol: L.Symbol.arrowHead({pixelSize: 15, pathOptions: {fillOpacity: 1, weight: 0, color: '#11CC11'}})  }
        ]
    }).addTo(map);

    decorator.getLayers()[0].bindPopup('Hello world!').openPopup();
}
